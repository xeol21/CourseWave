...
<form method="POST">
    ...
    <select name="title" id="title">
        ...
        <option value="Cybersecurity Instructor">Cybersecurity Instructor</option>
...
if (!empty($titleFilter)) {
    $q .= " WHERE title = '$titleFilter'";
}
$q .= " LIMIT $offset, $recordsPerPage";

$result = mysqli_query($mysql, $q) or die("Query Failed!!!");
if (mysqli_num_rows($result) > 0) {
    echo "<table id='instructorTable' border=5 cellspacing=10 cellpadding=10>";
    ...
    while ($r = mysqli_fetch_array($result)) {
        echo "<tr>
            ...
            <td>$r[3]</td>
            <td>$r[5]</td>
            <td> <center><img src='image/$r[4]' height='100px' width='100px'></center></td>
        </tr>";
    }
    ...
    $qTotal = "SELECT COUNT(*) as total FROM instructors";
...
function exportToExcel() {
    ...
    tableContent.unshift(["Instructor Name", "Title", "Bio", "Joined At"]);
